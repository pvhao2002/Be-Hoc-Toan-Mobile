...
public class Demhinh2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demhinh2);
        ...
        View.OnClickListener buttonClickListener = v -> {
            ...
            if (clickedButton.getId() == correctButtonId) {
                ...
                mediaPlayer = MediaPlayer.create(Demhinh2.this, R.raw.correct_sound); // Âm thanh đúng
                score++; // Tăng điểm số
            } else {
                ...
                mediaPlayer = MediaPlayer.create(Demhinh2.this, R.raw.wrong_sound); // Âm thanh sai
            }
    ...
    private void moveToNextActivity() {
        Intent intent = new Intent(Demhinh2.this, Demhinh3.class);
